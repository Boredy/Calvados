...
public class BlackJackController implements Initializable {
	...
	private PathTransition CreatePathTransition(Point2D fromPoint, Point2D toPoint, ImageView img) {
		...
		path.getElements().add(new CubicCurveTo(toPoint.getX() * 2, toPoint.getY() * 2, toPoint.getX() / 2,
	...
	private TranslateTransition CreateTranslateTransition(Point2D fromPoint, Point2D toPoint, ImageView img) {
		...
		TranslateTransition translateTransition = new TranslateTransition(Duration.millis(iAnimationLength / 2), img);
	...
	private ParallelTransition createFadeTransition(final ImageView imgVFadeOut, final Image imgFadeIn) {
		...
		FadeTransition fadeOutTransition = new FadeTransition(Duration.millis(iAnimationLength / 2), imgVFadeOut);
		...
		FadeTransition fadeInTransition = new FadeTransition(Duration.millis(iAnimationLength / 2), imgVFadeOut);
